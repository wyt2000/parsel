...
CONSTS = {
    ...
    "desc_helper": lambda desc: prepend_hash(f" You should implement a single function which meets the following requirements: {desc}") + "\n",
    "ret_helper": "# Returns: {ret}\n",
    "use_helper": "# You can call the functions immediately because they have already been implemented:\n{uses}\nYou shouldn't redefine them in your function.\n",
    "impl_helper": "{impls}",
